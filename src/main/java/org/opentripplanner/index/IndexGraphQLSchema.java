...
public class IndexGraphQLSchema {
    ...
    public IndexGraphQLSchema(GraphIndex index) {
        ...
        bikeParkType = GraphQLObjectType.newObject()
                ...
                .field(GraphQLFieldDefinition.newFieldDefinition()
                        .name("maxCapacity")
                        .description("Number of parking spaces in total")
                        .type(Scalars.GraphQLInt)
                        .dataFetcher(environment -> ((BikePark) environment.getSource()).maxCapacity)
                        .build())
                .field(GraphQLFieldDefinition.newFieldDefinition()
                        .name("realtime")
                ...
                .field(GraphQLFieldDefinition.newFieldDefinition()
                        .name("covered")
                        .description("Indicates if this bike parking space is covered by a roof.")
                        .type(Scalars.GraphQLBoolean)
                        .dataFetcher(environment -> ((BikePark) environment.getSource()).covered)
                        .build())
                .field(GraphQLFieldDefinition.newFieldDefinition()
                        .name("lon")
